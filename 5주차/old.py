...
gender_list = ['Male', 'Female']#성별
age_list = ['(0, 2)','(4, 6)','(8, 12)','(15, 20)','(25, 32)','(38, 43)','(48, 53)','(60, 100)']#나이범위
...
for i in range(dets.shape[2]):
    ...
    gender_index = gender_net.forward().squeeze().argmax()#차원축소후 가장 가능성 높은 인덱스 반환
    ...
    cv2.putText(img,text='%s,%s' %(gender,age),org=(x1,y1),fontFace=
                cv2.FONT_HERSHEY_SIMPLEX,fontScale=1,color=(0,255,0),thickness=2)
